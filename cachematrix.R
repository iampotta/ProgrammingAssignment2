...
### > source("cachematrix.R")    first load this program
### > a <- makeCacheMatrix()     call the function 
### > a$set(matrix(1:4, 2, 2))   create matrix in working local environment
### > cacheSolve(a)              the first run returns inverted matrix
